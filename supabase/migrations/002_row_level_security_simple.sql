-- =============================================================================
-- Row Level Security (RLS) Policies for SignalCX (Simplified Version)
-- =============================================================================
...
CREATE POLICY "Super admins can insert organizations"
    ...
    WITH CHECK (public.get_user_role() = 'super_admin'::user_role);
...
CREATE POLICY "Managers can update organization users"
    ON users FOR UPDATE
    USING (
        public.is_user_active() AND
        public.has_role_or_higher('manager'::user_role) AND
...
-- Agents and above can create tickets
...
-- Agents can update organization tickets
...
-- Managers can manage performance data
CREATE POLICY "Managers can create performance data"
...
CREATE POLICY "Managers can update performance data"
...
CREATE POLICY "Managers can delete performance data"
...
-- Agents can manage ticket analyses
CREATE POLICY "Agents can create ticket analyses"
...
CREATE POLICY "Agents can update ticket analyses"
    ON ticket_analyses FOR UPDATE
    USING (
        public.is_user_active() AND
        public.has_role_or_higher('agent'::user_role) AND
        ticket_id IN (
...
CREATE POLICY "Agents can delete ticket analyses"
