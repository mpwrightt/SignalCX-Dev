...
-- Create generated_tickets table (without foreign key constraint for now)
CREATE TABLE IF NOT EXISTS generated_tickets (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  organization_id TEXT NOT NULL,  -- Match the organization_id format from your existing schema
...
SELECT 'Generated tickets table created successfully!' as status;